...
### What I did
-I already have a GitHub account that I have not used for a while due to limited knowledge of the platform
-I logged into my account and was able to create a repo, project and file
-Then made several commit to my file created
-I downloaded the pre-bootcamp onboarding template file and edited it  and tried uplaoding

### What happened / Result
-I could see the changes I made to the session-00 pre-bootcamp onboarding file and I made corrections where necessary

### Challenges I faced
-File upload wasn't possible at first then I learnt to enable file upload I need to fork the repository
...
-Keep learning, nothing is difficult, you just need to be around the right circle to put you through
...
-https://www.youtube.com/watch?v=gLGoNLD_6Ms&t=1s
